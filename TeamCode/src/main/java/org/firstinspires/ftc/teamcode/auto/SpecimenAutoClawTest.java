...
public class SpecimenAutoClawTest extends LinearOpMode {
    ...
    public void buildTrajectories(double voltage) {
        marksPosFence[0] = new Pose2d(15.15+(12/voltage)/2,2,  Math.toRadians(5));
        marksPosFence[1] = new Pose2d(16.25+(12/voltage)/2,4,Math.toRadians(2));
        marksPosFence[2] = new Pose2d(17.4+(12/voltage)/2,5,Math.toRadians(-1));

        marksPosWall[0] = new Pose2d(13.75 -(12/voltage)/3,-31.5,Math.toRadians(-172));
        marksPosWall[1] = new Pose2d(13.25-(12/voltage)/3,-32.1,Math.toRadians(-177));
        marksPosWall[2] = new Pose2d(12,-32.8,Math.toRadians(-150));
