...
public class SampleAutoSample extends LinearOpMode {
    ...
    public void buildTrajectories(){
        ...
        spikeMarks[1] = bot.drive.trajectorySequenceBuilder(spikeMarks[0].end())
                //spike mark 1
                .lineToLinearHeading(new Pose2d(22 , 41, Math.toRadians(0)))
                ...
                .setVelConstraint(new MecanumVelocityConstraint(35 , 9.65))
                .setAccelConstraint(new ProfileAccelerationConstraint(15))
                .lineToLinearHeading(new Pose2d(11.5 , 40.5, Math.toRadians(-210)))
                .build();
        ...
        spikeMarks[2] = bot.drive.trajectorySequenceBuilder(spikeMarks[1].end())
                ...
                .setVelConstraint(new MecanumVelocityConstraint(35 , 9.65))
                .setAccelConstraint(new ProfileAccelerationConstraint(15))
                .lineToLinearHeading(new Pose2d(24.5, 43, Math.toRadians(25)))
                .build();
